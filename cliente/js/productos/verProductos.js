const contenedorProductos = document.getElementById('productsSection')
        ...
        nuevoProducto.innerHTML = `
            <div class="card h-100">
                ...
                <div class="badge badge-shadow bg-white text-dark position-absolute" style="top: 0.5rem; right: 0.5rem">
                    <a class="btn" id="verItem" href="item.html?name=${encodeURIComponent(producto.name)}&img=${encodeURIComponent(producto.img)}&price=${producto.price.toFixed(2)}"><i class="bi bi-eye-fill"></i></a>
                </div>
                <!-- Product image-->
